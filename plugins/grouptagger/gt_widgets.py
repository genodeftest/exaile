...
class GroupTaggerView(Gtk.TreeView):
    ...
    def get_context(self):
        ...
        context['groups'] = lambda name, parent: parent.get_selected_groups(context[
                                                                            'selected-rows'])
        context['categories'] = lambda name, parent: parent.get_selected_categories(context[
                                                                                    'selected-rows'])
        return context
...
class GroupTaggerQueryDialog(Gtk.Dialog):
    ...
    def __init__(self, groups):
        ...
        self.choices = [_('Must have this tag [AND]'), _('May have this tag [OR]'),
                        _('Must not have this tag [NOT]'), _('Ignored')]
