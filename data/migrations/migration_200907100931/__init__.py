...
def _migrate_old_tracks(oldsettings, db, ntdb):
    ...
    for oldtrack in oldtracks:
        # we shouldn't be checking os.path.isfile() here, since if it is a radio
        # link, it will not be migrated
        ...
        # hh:mm:YYYY, rather than hh:mm:ss. This is a workaround, that takes the
        # seconds == 0, since this information is lost b/c of the bug
